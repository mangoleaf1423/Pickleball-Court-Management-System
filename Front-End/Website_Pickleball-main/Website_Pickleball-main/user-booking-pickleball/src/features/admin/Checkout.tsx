  ...
  const handleSubmit = async () => {
    try {
      ...
      requestFCMToken().then(async (token) => {
        if (payload.phoneNumber && token) {
          try {
            await axios.post(`${CURRENT_ENV.API_URL}/identity/public/notification/save-token`, {
              ...
              <div className="flex items-center bg-green-800/50 p-4 rounded-xl">
                ...
                <div>
                  <span className="text-green-100 pl-2">
                    ...
                    <Button
                      type="link"
                      onClick={() => window.open('/dieu-khoan', '_blank')}
          ...
          <div className="max-w-screen-2xl mx-auto">
            <Button
              ...
              style={{
                ...
                transition: 'all 0.3s',
                ...(isAgreed ? {
                  background: 'linear-gradient(to right, #685E4EFF, #fbbf24)',
                  color: '#FFFFFFFF',
                  border: 'none',
